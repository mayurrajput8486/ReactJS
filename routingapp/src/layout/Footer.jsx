const Footer = () => {
    return (
        <div>
            <div className="w-100 bg-primary fs-3 p-3 fw-bold">
            ...
            <div className="d-flex justify-content-evenly p-3">
                <div className="bg-light p-3 border border-3 w-25 rounded-4">
                    ...
                    <div>
                        <i className="bi bi-geo-alt"></i>: S.No. 48/1/5, 6 & 7, Floor no. 1, Pashan - Sus Rd, Baner, Pune, Maharashtra 411045
                    </div>
                    <div>
                        &#128222; : 8888666688
                    </div>
