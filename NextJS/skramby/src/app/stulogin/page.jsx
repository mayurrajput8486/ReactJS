    ...
    const stuLogin = async(data) =>{
        try{
            ...
            if(student){
                ...
                router.push(`/studashboard?id=${student.id}`)
            }else{
                                        ...
                                        <div className="card-body p-md-5 mx-md-4">
                                            ...
                                            <Form>
                                                ...
                                                <div className="d-flex align-items-center justify-content-center pb-1">
                                                   ...
                                                   <Link href='/register'><button type="button" data-mdb-button-init data-mdb-ripple-init className="btn btn-outline-danger">Register Now</button></Link>
                                                </div>
                                            </Form>
                                            </Formik>
                                        </div>
